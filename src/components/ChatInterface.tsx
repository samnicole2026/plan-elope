...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ onClose, isEmbedded = false }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hi! I'm Plan-elope, your AI scheduling assistant. Tell me about your upcoming commitments, goals, or what you'd like to accomplish!",
      timestamp: new Date(),
    },
  ]);
  ...
  // Original modal version (kept for backwards compatibility)
  return (
